...
*/
export default function slideTouch(slideSelector, slideActiveSelector, activeClass) {
		...
		var slideActive = document.querySelectorAll(slideActiveSelector); // 焦点图下方的点
		...
		function slideChangeHandle() {
			...
			// 焦点图位移，当前第几张图片 * 视口宽度为7.5rem
			translateX = -slideIndex * 7.5;
			slide.style.transform = 'translateX(' + translateX + 'rem)';
